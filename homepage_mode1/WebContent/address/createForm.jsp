...
<body>
	...
	<form action="./createProc.jsp" method="POST" onsubmit="return input(this)">
		<table>
			<tr>
				<th>이름</th>
				<td>
			...
			<tr>
				...
				<td>
					...
					<input type="button" class="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" />
				<td>
			<tr>
			<tr>
				<th>주소</th>
		...
		<div class="bottom">
			<input type="submit" class="button" value="등록" /> <input type="reset" class="button" value="다시입력" />
