...
<DIV class="title">처리 결과</DIV>
  ...
  <DIV class='bottom'>
    <input type='button'  class="button" value='다시시도' onclick="history.back()"> 
    <input type='button' class="button"  value='목록' onclick="ilist()">
  </DIV>

  <% }else{ %>
  
  <DIV class='bottom'>
    <input type='button'  class="button" value='다시등록' onclick="location.href='createForm.jsp'"> 
    <input type='button'  class="button" value='목록' onclick="ilist()">
